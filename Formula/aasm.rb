class Aasm < Formula
  ...
  on_macos do
    on_arm do
      ...
      sha256 "99ae1ba591f3f2a65fc3aaac6101b1a8fed029ee65ffca5cc638e73ee476f670"
    end
    on_intel do
      url "https://github.com/ai-agent-assembly/agent-assembly/releases/download/v#{version}/aasm-x86_64-apple-darwin.tar.gz"
      sha256 "1f2b740ec55fcd7aca26ca7d5a1e75bb2667a27ee9b46994ffe44462aa46cbba"
    end
  end
  ...
  on_linux do
    on_arm do
      ...
      sha256 "3adfc4e86a3c8a631b83cae53642c615eb24bfdfcc1f54b3648fa59e289162d0"
    end
    on_intel do
      url "https://github.com/ai-agent-assembly/agent-assembly/releases/download/v#{version}/aasm-x86_64-unknown-linux-gnu.tar.gz"
      sha256 "9ad9011b009f7380a11da95be63e08c73344ea6638828c155cfcc68941ff0737"
    end
  end
